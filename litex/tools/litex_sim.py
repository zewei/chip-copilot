...
# 本文件是LiteX的一部分。
#
# 版权所有 (c) 2015-2020 Florent Kermarrec <florent@enjoy-digital.fr>
# 版权所有 (c) 2020 Antmicro <www.antmicro.com>
# 版权所有 (c) 2017 Pierre-Olivier Vauboin <po@lambdaconcept>
# 版权所有 (c) 2023 Victor Suarez Rovere <suarezvictor@gmail.com>
    ...
    def __init__(self,
        ...
        **kwargs):
        ...
        if not self.integrated_main_ram_size and with_sdram:
            sdram_clk_freq = int(100e6) # FIXME: 使用100
